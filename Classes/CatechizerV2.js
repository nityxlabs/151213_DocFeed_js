...
qK = {};
qK["what_is"] = [];
qK["what_is"].push( "@@x>>\\bis\\b|\\bwas\\b::0::1>>\\ba\\b|\\ban\\b|\\bthe\\b|\\bdefined\\b|\\bdescribed\\b|\\beither\\b::0::1" );      //x is\was a\the
// qK["what_is"].push( "@@x>>\\bis\\b&&\\bwas\\b::0::1>>\\ba\\b&&\\ban\\b&&\\bthe\\b::0::1" );      //x is\was a\the
qK["what_is"].push( "@@x>>\\bare\\b::0::1>>\\Ss\\b::0::1" );      //x are [word]s
qK["what_is"].push( "@@x>>\\bis\\b|\\bare\\b::0::1>>\\blike\\b::0::1" );      //x is|are like
qK["what_is"].push( "@@x>>\\bcan\\b::0::1>>\\bbe\\b::0::1>>\\bdefined\\b|\\bdescribed\\b::0::2" );      //x is|are like

qK["what_does_it_do"] = [];
qK["what_does_it_do"].push( "@@x>>\\bcause|\\bcausing\\b|\\bcausation\\b::0::2" );   //form regular expression = /\bcause|\bcausing\b|\bcausation/gi; where "|" means OR
qK["what_does_it_do"].push( "@@x>>\\baffect|\\bchange|\\bincrease|\\bdecrease::0::2" );

qK["what_can"] = [];
qK["what_can"].push( "@@x>>\\bcan\\b::0::2" );

qK["what_compose"] = [];
qK["what_compose"].push( "@@x>>\\bis\\b&&\\bwas\\b::0::2>>\\bcompos|\\bcompris|\\bmade\\sup::0::2" );
qK["what_compose"].push( "@@x>>\\bconsist::0::2>>\\bof\\b::0::2" );
qK["what_compose"].push( "@@x>>\\bconsist::0::2" );

qK["what_known"] = [];
qK["what_known"].push( "@@x>>\\bis\\b|\\bwas\\b::0::2>>\\bknown\\b|\\bbelieve|\\bthought\\b|\\bassume::0::1");

qK["what_associate"] = [];
qK["what_associate"].push( "@@x>>\\bis\\b|\\bwas\\b::0::2>>\\bassociate|\\bcorrelate|\\baffiliate|\\blink|\\bconnect::0::1");
qK["what_associate"].push( "@@x>>\\bassociat|\\bcorrelat|\\baffiliat|\\blink|\\bconnect::0::1");

qK["why"] = [];
qK["why"].push( "@@x>>\\bbecause\\b::0::2" );

qK["when"] = [];
qK["when"].push( "@@x>>\\bhappen|\\boccur::0::2" );

qK["where"] = [];
qK["where"].push( "@@x>>\\boccur::0::2>>\\bin\\b::0::1" );
...
qK["how_made"].push( "@@x>>\\bis\\b|\\bwas\\b|\\bare\\b::0::2>>\\bmade\\b|\\bcreat|\\bsynthesiz|\\bgenerat|\\bdevelop|\\bproduc|\\bconstruct|\\bassembl|\\bmanufactur|\\bbuil|\\bdesign::0::2" );
...
Catechizer.prototype = {
    ...
    answerQuesType: function(str, qType, transposons) {
        ...
        //METHOD: determines if questino type 'qType' is present in 'str', returns true if present & false if not present
