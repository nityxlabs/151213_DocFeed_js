...
Catechizer.prototype = {
    ...
    answerPresentTEMPv2: function(str, transposons) {
        ...
        var quesCateg = {};     //records potential questions, where key = question category, value = array of indices
        for (var q in qK) {     //q = string that is question type, qK[q] = array of question structures for specific question type
            ...
            if (qPresent.length > 0)
                quesCateg[q] = qPresent;        //if question type not present, then record question type
        }
